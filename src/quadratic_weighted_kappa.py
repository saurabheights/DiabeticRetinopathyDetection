# Taken from https://github.com/benhamner/Metrics/blob/master/Python/ml_metrics/quadratic_weighted_kappa.py
# and adapted for PyTorch
    ...
    for i in range(num_ratings):
        for j in range(num_ratings):
            expected_count = (hist_rater_a[i] * hist_rater_b[j]
                              / num_scored_items)
            d = _safe_div(pow(i - j, 2.0), pow(num_ratings - 1, 2.0))
