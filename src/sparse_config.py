...
from Sparse_ResNet import Sparse_Res_Net 
import sparseconvnet as scn
data_params = {
    'train_path': '../../data/full_train/train',
    'test_path': '../../data/full_test/test',
...
transfer_learn = model_params['model_kwargs']
...
test_data_transforms = transforms.Compose([
    ...
    transforms.CenterCrop((224)),
    transforms.ToTensor(),
    #transforms.Lambda(lambda x: input.addSample() ) 
