...
# plt.title('loss Comparision-Training vs Val')
# plt.xlabel('Epoch')
# plt.ylabel('loss')
# Yellow_patch = mpatches.Patch(color='yellow', label='Training Error')
# Red_patch = mpatches.Patch(color='red', label='Validation Error')
# plt.legend(handles=[Red_patch,Yellow_patch])
#
# plt.plot(Train_Loss, 'y', label='baseline',linewidth=2.0)
# plt.plot(val_loss, 'r', label='batchnorm',linewidth=2.0)
# plt.show()
#
# plt.figure(figsize=(15,15))
# plt.title('QWK Score Comparision-Training vs Val')
# Yellow_patch = mpatches.Patch(color='yellow', label='Training QWK_Score')
# Red_patch = mpatches.Patch(color='red', label='Validation QWK_Score')
# plt.legend(handles=[Red_patch,Yellow_patch])
# plt.xlabel('Epoch')
# plt.ylabel('QWK')
# plt.plot(Train_QWK, 'y', label='baseline',linewidth=2.0)
# plt.plot(Val_QWK, 'r', label='batchnorm',linewidth=2.0)
# plt.show()
